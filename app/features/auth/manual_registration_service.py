...
class ManualRegistrationService:
    ...
    async def create_self_service_registration(
        ...
        if payload.game is not SupportedGame.CIV7 or payload.platform is not RegistrationPlatform.TWOK:
        ...
        return await self._registration_service.create_self_service_registration_operation(
            discord_user_id=payload.discord_user_id,
            game=payload.game,
            platform=RegistrationPlatform.TWOK,
            account_id=payload.platform_account_id,
